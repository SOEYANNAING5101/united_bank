...
const UserProfilePage = () => {
  ...
  if (state === "UNVERIFIED") {
    return (
      <VerificationGate>
        <UserProfileMockLayout />
      </VerificationGate>
    );
  }
  return <UserProfileRealLayout />;
};
export default UserProfilePage;

const UserProfileRealLayout = () => {
  ...
  return (
    <div className="mt-10 px-2 flex items-center justify-center">
      <Toaster
        position="top-right"
        reverseOrder={false}
        toastOptions={{
      ...
      <div className={`flex flex-col w-full md:max-w-4/5`}>
        ...
        <div className="flex flex-col md:px-10 pt-8 py-4 px-4 border-b border-gray-200">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <div className={`px-2 py-1 rounded-full bg-red-700`}>
                <span className="text-xs text-white">Unverified</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className=" flex items-center gap-5 md:px-10 md:pt-8 py-4 px-4">
          {/* Profile Pic */}
          <div className="shrink-0 ">
            <div className="bg-blue-200 relative group w-25 h-25 rounded-full flex items-center justify-center overflow-hidden ">
              <User size={35}/>
            </div>
          </div>
          <div className="flex flex-col">
            <span className="text-base md:text-lg font-bold">John Doe</span>
            <span className="text-gray-700 text-sm">john1234@gmail.com</span>
          </div>
        </div>
        ...
        <div className="flex flex-col md:px-10 py-4 px-4">
          <div className="flex items-center relative mb-4">
            ...
            <button
              type="button"
              className="flex gap-1 items-center justify-center text-blue-700 right-0 top-0 absolute"
            >
              <Pencil size={10} />
              <span className="text-xs">Edit</span>
            </button>
          ...
          <div className="w-full flex flex-col mb-4 tracking-wider">
            <label className="text-xs text-gray-600">Street Address</label>
            <span className="text-xs md:text-sm  text-gray-900 font-semibold">
              Blk 256, Bukit Batok East Ave 4
            </span>
          </div>
          {/* City, Country, State/Province */}
          <div className="flex grid grid-cols-3 mb-4 w-full items-center justify-between">
