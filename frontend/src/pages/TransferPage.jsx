...
import TransferPageSkeleton from "./components/skeleton/TransferPageSkeleton";
...
const TransferPage = () => {
  ...
  if (state === "LOADING") return <TransferPageSkeleton />;
  if (state === "UNVERIFIED") {
    return (
      <VerificationGate>
        <TransferMockLayout />
      ...
      <div className="grid lg:grid-cols-8 md:gird-cols-1 gap-2">
        ...
        <div className="lg:col-span-3 mt-2 h-full space-y-2 bg-gray-100">
          ...
          <div className=" rounded-xl shadow-lg bg-blue-700 text-white p-6">
            <h3 className="text-medium md:text-lg font-semibold mb-5">
              Balance Summary
            </h3>
      ...
      <div className="pointer-events-none grid lg:grid-cols-8 md:gird-cols-1 gap-2">
        <div className="lg:col-span-5 rounded-xl md:shadow-lg bg-gray-100 md:bg-white">
          <div className="md:p-4">
            ...
            <div className="mt-3 mb-3 relative">
              ...
              {/* Mobile */}
              <button className="pointer-events-none md:hidden w-full px-4 py-3 rounded-xl border border-gray-300 bg-gray-50 font-medium">
                <div className="flex gap-4 items-center w-full">
                  <div className="w-12 h-12 rounded-full bg-blue-700 flex justify-center items-center">
                    <PiggyBank color="white" size={24} strokeWidth={1.25} />
                  </div>
                  <div className="text-left flex flex-col">
                    <span className="text-sm font-bold">Checking Accouont</span>
                    <span className="text-xs md:sm text-gray-700">
                      Available: $5000,00
                    </span>
                  </div>
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <button className="flex justify-between items-center text-gray-700 font-semibold w-full p-3 rounded-lg text-sm border border-gray-300 bg-gray-50 hover:bg-gray-100">
            ...
            <div className="mb-3">
              ...
              <div className="flex gap-3">
                <input
                  value="1234567898"
                  className={`w-full px-4 py-3 rounded-xl text-xs md:text-sm bg-gray-50 font-medium border border-gray-300`}
                ></input>
                <button className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white px-6 rounded-xl font-semibold transition-colors flex items-center gap-2">
                  Verify
                </button>
              </div>
              {/* Success message */}
              <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-2 mt-1 flex items-center gap-2 text-emerald-700">
                <CheckCircle size={18} />
                <p className="text-sm font-medium">
                  Verified: <span className="font-bold">John Doe</span>
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              >
                ...
                <div className="flex justify-center gap-3 md:gap-4 mb-2">
                  {[100, 500, 1000].map((val) => (
                    <button className="px-2.5 text-sm  transition-colors py-1 bg-white border border-gray-300 rounded-full hover:bg-gray-100 hover:borer-gray-400">
                      +${val}
                    </button>
                  ))}
                </div>
              ...
              <div className="mt-2">
                ...
                <input
                  value="Rental"
                  className="w-full px-4 py-6 rounded-xl text-xs md:text-sm border border-gray-300 bg-gray-50 font-medium"
                ></input>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-3 mt-2 h-full space-y-2 bg-gray-100">
          ...
          <div className=" rounded-xl shadow-lg bg-blue-700 text-white p-6">
            ...
            <div className="flex justify-between mt-4 text-lg font-bold border-t">
              <span className="text-sm mt-2">New Balance</span>
              <span className="font-medium mt-2">$ 45000</span>
            </div>
          </div>
          {/* Transaction summary */}
          <div className=" rounded-xl shadow-lg bg-white flex-grow p-6">
            ...
            <div>
              ...
              <p className="text-gray-800 italic">"Rental"</p>
            </div>
          </div>
          {/* Confirm transfer button */}
          <div className="lg:row-span-1 animate-fade-in">
            <button className="w-full bg-blue-600 hover:bg-blue-700 cursor-pointer text-white disabled:bg-gray-400 disabled:cursor-not-allowed font-bold py-4 rounded-xl shadow-md transition-colors flex justify-center items-center gap-2">
              Next
            </button>
          </div>
        </div>
